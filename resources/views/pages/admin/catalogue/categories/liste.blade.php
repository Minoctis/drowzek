<div class="col-xs-12">
    ...
    <ol class="sortable-2-levels liste-categorie">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-2"><span class="glyphicon glyphicon-move"></span> {{ $categorie->ordre }}</div>
                            ...
                            <div class="col-xs-2"><a href="" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></div>
                        </div>
                    </div>
                </div>
            </div>
            @if(!empty($categorie->children))
                <ol class="sortable-1-level children">
                        ...
                        <li class="list-unstyled" data-id="{{ $child->id }}" id="categorie_{{ $child->id }}">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-xs-2"><span class="glyphicon glyphicon-move"></span> {{ $child->ordre }}</div>
