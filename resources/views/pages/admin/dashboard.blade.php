    ...
    <div id="dashboard-page">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <a href="{{ route('admin::commandes::liste') }}" class="item-dashboard-page">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
                <a href="{{ route('admin::produits::liste') }}" class="item-dashboard-page">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
                <a href="{{ route('admin::avis::liste') }}" class="item-dashboard-page">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
                <a class="item-dashboard-page" style="cursor: text;">
