...
<div class="container">
	<div class="fiche-ambiance">
		<div class="row border-ambiance padding-header">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-images">
				<div class="align-bottom bloc-images">
					<div class="carousel slide article-slide" id="myCarousel-ambiance">
				     	<div class="carousel-inner cont-slider">
					        ...
					        <div class="item">
					          <img src="http://placehold.it/1200x500/999999/cccccc">
					        </div>
					        <div class="item">
					          <img src="http://placehold.it/1200x500/dddddd/333333">
					        </div>               
				     	</div>
				      <!-- Indicators -->
