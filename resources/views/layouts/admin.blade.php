    ...
    <div id="wrapper" class="active">
        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav" id="sidebar">
                ...
                <li @if(\Request::route()->getName() == 'admin::pages::liste'){{ 'class=active' }}@endif><a href="{{ route('admin::pages::liste') }}">Pages<span class="sub-icon glyphicon glyphicon-link"></span></a></li>
                ...
                <li @if(\Request::route()->getName() == 'admin::theme::liste'){{ 'class=active' }}@endif><a href="{{ route('admin::theme::liste') }}">Thème<span class="sub-icon glyphicon glyphicon-tint"></span></a></li>
